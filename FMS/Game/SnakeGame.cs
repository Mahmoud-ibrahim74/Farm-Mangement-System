...
namespace FMS.Game
{
    public partial class SnakeGame : Form
    {
        ...
        {
            InitializeComponent();
            this.HighScore.Text = Properties.Settings.Default.HighScore.ToString();
            //Set settings to default
            new Settings();

            //Set game speed and start timer
            gameTimer.Interval = VarSpeed / Settings.Speed;
        ...
        private void pbCanvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            else
            {
                ...
                int temp = Properties.Settings.Default.HighScore;
                Properties.Settings.Default.HighScore = Math.Max(Settings.Score, temp);
        ...
        private void Eat()
        {
            ...
            Snake.Add(circle);
            if(VarSpeed != 500) // to change speed of snake when eat
            {
                VarSpeed -= 100;
                gameTimer.Interval = VarSpeed / Settings.Speed;
            }
            ...
            this.Text ="Score  :  " +  Settings.Score.ToString();
