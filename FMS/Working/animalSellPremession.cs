...
{
    public partial class animalSellPremession : Form
    {
        DataTable dt = new DataTable();
        DataTable dt3 = new DataTable();
        int GetAnimalNumbers = 0;
        public animalSellPremession()
        {
            InitializeComponent();
        ...
        private void backgroundWorker_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            SQLSERVER_Queries.workingScripts.AnimalWorkingScripts animal = new SQLSERVER_Queries.workingScripts.AnimalWorkingScripts();
        ...
        private void numbers_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                GetAnimalNumbers = Convert.ToInt32(numbers.Text);
        ...
        private void guna2Button4_Click(object sender, EventArgs e)
        {
            ClickSound sound = new ClickSound();
            sound.RunClickSound();
            int getCurrentNumbers = Convert.ToInt32(numbers.Text);
            if (anavar.SelectedIndex == -1 || animal_type.SelectedIndex == -1)
            {
            ...
            else if (GetAnimalNumbers <= 0)
            {
                MessageBox.Show("عدد العنبر الحالي لا يسمح \n برجاء اضافة عدد", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);

            }
            else if (getCurrentNumbers > GetAnimalNumbers)
            {
                MessageBox.Show("برجاء ادخال عدد اقل من عدد العنبر", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void animalSellPremession_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void animalSellPremession_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose();
